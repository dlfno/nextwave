ALTER TABLE mandate_versions
  ADD COLUMN ap2_open_checkout_payload jsonb,
  ADD COLUMN ap2_open_checkout_credential text,
  ADD COLUMN ap2_open_checkout_hash bytea,
  ADD COLUMN ap2_open_payment_payload jsonb,
  ADD COLUMN ap2_open_payment_credential text,
  ADD COLUMN ap2_open_payment_hash bytea;
